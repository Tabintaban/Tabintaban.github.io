...
#### До "Дня Д" (Before D-Day).  
  * Выпуск купонов, программ прислужников (slave-programm)  
...
#### После "Дня Д" (After D-Day).  
  * "День Д + 1 год" (D-Day + 1 year) - дата окончания распространения купонов, программ прислужников (slave-programm) среди генераторов гудвилла и благотворителей.  
